...
if not all([SHEET_ID, N8N_WEBHOOK, X_API_KEY]):  # CAMBIO AQUÍ
...
def send_to_n8n(username, posts):
    ...
    try:
        headers = {
            ...
            'X-API-KEY': X_API_KEY  # CAMBIO AQUÍ - usar la variable renombrada
        }
        ...
        st.write(f"🔧 Debug - X-API-KEY: {X_API_KEY[:20]}...")
